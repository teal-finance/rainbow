...
=======
	github.com/teal-finance/garcon v0.13.8
	github.com/teal-finance/notifier v1.0.0
>>>>>>> 8e4d882 (⬇️ Downgrade indirect dependencies)
...
require (
	...
	github.com/teal-finance/incorruptible v0.0.0-20220620234923-57a369cf0477 // indirect
