...
func (v *HardCodedChain1_swapsSwap) GetTimestamp() int { return v.Timestamp }
...
func (v *HardCodedChain1_swapsSwap) GetLogIndex() int { return v.LogIndex }
...
func (v *HardCodedChain1_swapsSwapPair) GetTxCount() int { return v.TxCount }
...
func (v *HardCodedChain1_swapsSwapPair) GetCreatedAtTimestamp() int { return v.CreatedAtTimestamp }
...
func (v *HardCodedChain1_swapsSwapPair) GetCreatedAtBlockNumber() int { return v.CreatedAtBlockNumber }
...
func (v *HardCodedChain1_swapsSwapPair) GetLiquidityProviderCount() int {
...
type Swap_filter struct {
	...
	Timestamp                          int       `json:"timestamp"`
	Timestamp_not                      int       `json:"timestamp_not"`
	Timestamp_gt                       int       `json:"timestamp_gt"`
	Timestamp_lt                       int       `json:"timestamp_lt"`
	Timestamp_gte                      int       `json:"timestamp_gte"`
	Timestamp_lte                      int       `json:"timestamp_lte"`
	Timestamp_in                       []int     `json:"timestamp_in"`
	Timestamp_not_in                   []int     `json:"timestamp_not_in"`
	...
	LogIndex                           int       `json:"logIndex"`
	LogIndex_not                       int       `json:"logIndex_not"`
	LogIndex_gt                        int       `json:"logIndex_gt"`
	LogIndex_lt                        int       `json:"logIndex_lt"`
	LogIndex_gte                       int       `json:"logIndex_gte"`
	LogIndex_lte                       int       `json:"logIndex_lte"`
	LogIndex_in                        []int     `json:"logIndex_in"`
	LogIndex_not_in                    []int     `json:"logIndex_not_in"`
	AmountUSD                          float64   `json:"amountUSD"`
